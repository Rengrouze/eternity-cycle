...
/**
 * Fiche d'Item Objet Divers (ItemSheetV2) - édition complète, indépendante
 * de la fiche Acteur (voir weapon-sheet.mjs pour le raisonnement).
 */
export class MiscItemSheet extends HandlebarsApplicationMixin(ItemSheetV2) {
  static DEFAULT_OPTIONS = {
    classes: ["l5r4ec", "sheet", "item", "misc"],
    position: { width: 480, height: 520 },
    window: { resizable: true },
    form: { submitOnChange: true },
    actions: {
      editImage: MiscItemSheet.#onEditImage
    }
  };

  /** @override */
  static PARTS = {
    body: { template: "systems/l5r4ec/templates/item/misc-sheet.hbs" }
  };
