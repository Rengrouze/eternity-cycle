...
/**
 * Fiche d'Item Munition (ItemSheetV2) - édition complète, indépendante de
 * la fiche Acteur (voir weapon-sheet.mjs pour le raisonnement).
 */
export class AmmoSheet extends HandlebarsApplicationMixin(ItemSheetV2) {
  static DEFAULT_OPTIONS = {
    classes: ["l5r4ec", "sheet", "item", "ammo"],
    position: { width: 480, height: 520 },
    window: { resizable: true },
    form: { submitOnChange: true },
    actions: {
      editImage: AmmoSheet.#onEditImage
    }
  };

  /** @override */
  static PARTS = {
    body: { template: "systems/l5r4ec/templates/item/ammo-sheet.hbs" }
  };
